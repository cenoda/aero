...
- [ ] **1. `EditorViewModel` never unsubscribes from MessageBus**
...
- [ ] **2. `FindReplaceOverlay` never focuses the Replace field**
...
- [ ] **3. `EditorView` leaks `FindReplaceRequested` subscription**
...
- [ ] **4. App exit doesn't check for dirty documents**
...
- [ ] **5. `DocumentManager._lastDirtyState` leaks on app exit**
